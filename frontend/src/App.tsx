...
// Team Class with components to print each team individualls
  ...
  render() {
    ...
    return (
      <div className="card">
        ...
        <h3>{singleTeam.city}, {singleTeam.state}</h3>
        <br/>
      </div>
    );
  }
...
// Go through each team in list and send them to Team Class
function TeamList() {
  return (
    <div>
